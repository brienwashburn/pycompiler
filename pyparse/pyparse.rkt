...
(funcdef
 (($def59 NAME parameters $nt60 $:63 suite)
  (let-syntax (($
                (λ (stx)
                  (syntax-case stx ()
                    ((_ n)
...
(expr_stmt
 ((testlist_star_expr augassign $nt123)
  (let-syntax (($
                (λ (stx)
                  (syntax-case stx ()
                    ((_ n)
...
(comp_for
 (($for397 exprlist $in398 or_test $nt399)
  (let-syntax (($
                (λ (stx)
                  (syntax-case stx ()
                    ((_ n)
