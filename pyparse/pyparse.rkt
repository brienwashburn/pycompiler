...
(comp_for
 (($for445 exprlist $in446 or_test $nt447)
  (let-syntax (($
                (λ (stx)
                  (syntax-case stx ()
                    ((_ n)
