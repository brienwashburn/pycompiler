...
(comp_for
 (($for436 exprlist $in437 or_test $nt438)
  (let-syntax (($
                (λ (stx)
                  (syntax-case stx ()
                    ((_ n)
