...
(for_stmt
 (($for244 $nt245 $in246 testlist $:247 suite $nt248)
  (let-syntax (($
                (λ (stx)
                  (syntax-case stx ()
                    ((_ n)
...
(lambdef_nocond
 (($lambda302 $nt303 $:304 test_nocond)
  (let-syntax (($
                (λ (stx)
                  (syntax-case stx ()
                    ((_ n)
                     ...
                     (datum->syntax
                      ...
                      (string->symbol
                       (string-append
                        "$"
                        (number->string (syntax->datum #'n))))))))))
    (let-syntax (($$ (λ (_) #'(list ($ 1))))) (process-string ($ 1)))))
 (($...370)
  (let-syntax (($
                (λ (stx)
                  (syntax-case stx ()
...
(comp_for
 (($for453 exprlist $in454 or_test $nt455)
  (let-syntax (($
                (λ (stx)
                  (syntax-case stx ()
                    ((_ n)
  ...
  (let-syntax (($
    ...
    (let-syntax (($$ (λ (_) #'(list ($ 1) ($ 2) ($ 3) ($ 4) ($ 5)))))
      (if ($ 5)
        `(,($ 2) ,@($ 4) ,@(process-if '() ($ 5)))
        `(,($ 2) ,@($ 4))))))
 (($if222 test $:223 suite $nt224 $nt228)
  (let-syntax (($
                (λ (stx)
                  (syntax-case stx ()
                    ((_ n)
