...
(comp_for
 (($for396 exprlist $in397 or_test $nt398)
  (let-syntax (($
                (λ (stx)
                  (syntax-case stx ()
                    ((_ n)
