...
(simple_stmt
 ((small_stmt $nt117 $nt120 NEWLINE)
  (let-syntax (($
                (λ (stx)
                  (syntax-case stx ()
                    ((_ n)
...
(if_stmt
 (($if204 test $:205 suite $nt206 $nt210)
  (let-syntax (($
                (λ (stx)
                  (syntax-case stx ()
                    ((_ n)
...
(for_stmt
 (($for220 exprlist $in221 testlist $:222 suite $nt223)
  (let-syntax (($
                (λ (stx)
                  (syntax-case stx ()
                    ((_ n)
...
(with_stmt
 (($with243 with_item $nt244 $:247 suite)
  (let-syntax (($
                (λ (stx)
                  (syntax-case stx ()
                    ((_ n)
...
(lambdef_nocond
 (($lambda265 $nt266 $:267 test_nocond)
  (let-syntax (($
                (λ (stx)
                  (syntax-case stx ()
                    ((_ n)
...
(comp_for
 (($for386 exprlist $in387 or_test $nt388)
  (let-syntax (($
                (λ (stx)
                  (syntax-case stx ()
                    ((_ n)
